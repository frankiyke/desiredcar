...
if (@!$_SESSION["user_login"]){
    echo'<meta http-equiv="refresh" content="0;url=Newrequest">';
    exit();
    }else{}
...
$message = $owner.' has requested for a car ('.$brand.' '.$model.') with Customer number :'.$customerid; 
$from = $email;

$input = "INSERT INTO request (phone_number, owner, customerid, brand, model, doors, transmission, body, cylinder, discription, mileage, engin, gas, gear, drive, year) VALUES ('$phone_number', '$name', '$customerid', '$brand', '$model', '$doors', '$transmission', '$body', '$cylinder', '$discription', '$mileage', '$engin', '$gas', '$gear', '$drive', '$year')";

$updateinfo = mysqli_query($dbconn, $input);
              ...
              <form action="" method="POST" >
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="name"><h4>Hello <?php echo $name; ?>, you are making a car request.</h4></label>
					  ...
					  An agent will get in-touch with you within 48 working hours.</p>
                    </div>
                  </div>
				  		<input type="hidden" id="name" name="owner" required="require" value="<?php echo $name; ?>" class="form-control py-2">
                        <input type="hidden" id="name" name="phone_number" required="require" value="<?php echo $phone_number; ?>" class="form-control py-2">
				  ...
				  <div class="row">
                    <div class="col-md-6 form-group">
                      <label for="name">Preferred Car Colour</label>
