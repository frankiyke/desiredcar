...
$gethem = "SELECT * FROM cars WHERE status='Sold'";
$records = mysqli_query($dbconn, $gethem);
$count = mysqli_num_rows($records);
echo "<h1>You have sold total of $count Cars </h1> ";
...
$gethem = "SELECT * FROM cars WHERE status='Sold' ORDER BY id DESC LIMIT $num, $result_per_page";
$records = mysqli_query($dbconn, $gethem);
$count = mysqli_num_rows($records);
...
<?php
	...
	echo "<h1> There is No sold car Yet...</h1>"; 
}
